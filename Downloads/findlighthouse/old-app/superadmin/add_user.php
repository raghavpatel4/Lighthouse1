    ...
    <div class="right_col" role="main">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <form method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input id="checkUserEmailId" data-id="1" class="form-control col-md-7 col-xs-12" name="email_id" placeholder="Email Address" required="required" type="email" />
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input id="study" class="form-control col-md-7 col-xs-12" name="study" placeholder="Study" type="text" />
                    </div>
                  </div>
                  <div class="item form-group">
      ...
      <?php 
		...
		if(isset($_POST['save_data'])) {
			...
			if($user_id > 0) {
				$to = $email_add;
				$subject = "Your New Student Account Active in Lighthouse!";
				
				$htmlContent = '<html>
				<body>
					<p align="center"><img src="'.$webUrl.'assets/img/site-logo.png" alt="Lighthouse" /></p>
					<h1>Your New Student Account Active in Lighthouse!</h1>
					<p>Hello '.$full_name.',<br />Your Student Account is Now Active.</p>
