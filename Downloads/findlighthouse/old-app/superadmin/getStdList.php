                        ...
                        <?php for($i = 0; $i < count($totalNoTeahcer); $i++) {?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                        <a href="user-list.php?acc_act=<?php echo $totalNoTeahcer[$i]['id'];?>&status=1" class="btn btn-warning xs-btn" onClick="return confirm('Are you sure this Account Active?')">Block</a>
                                    <?php
                                        } else {
                                    ?>
                                        <a href="user-list.php?acc_act=<?php echo $totalNoTeahcer[$i]['id'];?>&status=0" class="btn btn-success xs-btn" onClick="return confirm('Are you sure this Account Disable?')">Active</a>
                                    <?php
                                        }
                                    ?>
                                </td>
