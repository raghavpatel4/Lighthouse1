                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="item form-group centered">
                                    <div class="col-md-12 col-sm-12 col-xs-12"><input type="submit" name="registration_button" value="Registration" class="signupRegistration btn btn-success" data-id='1' /></div>
                                </div>
